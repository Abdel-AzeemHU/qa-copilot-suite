...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    subtitle: "Portable Playwright/Selenium TS & REST Assured Java — code you own",
    stage: "ai",
    activity: "Synthesising portable Playwright TypeScript from 284 test cases, with page object patterns and fixtures — exportable, zero lock-in…",
    stats: [
  ...
  },
  {
    id: 7,
    title: "Execute Tests",
    subtitle: "Live logs streaming in real time, parallel runs",
    stage: "execution",
    activity: "Running suite against https://app.example.com across 4 parallel workers — streaming live logs, screenshots on failure…",
    stats: [
  ...
  },
  {
    ...
    subtitle: "Heal selectors mid-test, repair whole scripts after",
    stage: "execution",
    activity: "8 selectors broke after a UI update — healing locators mid-run, then AI rewrites the affected scripts post-run…",
    stats: [
      { label: "Healed Mid-Test", value: 8, suffix: "" },
      { label: "Scripts Repaired", value: 3, suffix: "" },
    ],
  ...
  },
  {
    ...
    subtitle: "Every failure labeled: real bug, flaky, environment, automation",
    stage: "execution",
    activity: "Classifying 9 remaining failures — 3 real bugs, 4 flaky (quarantined), 1 environment issue, 1 automation error…",
    stats: [
      { label: "Real Bugs", value: 3, suffix: "" },
      { label: "Flaky Quarantined", value: 4, suffix: "" },
    ],
  ...
  {
    id: 12,
    title: "Flakiness-Aware CI Merge Gate",
    subtitle: "Block PRs on real bugs — never on known-flaky tests",
    stage: "pipeline",
    activity: "GitHub Action evaluating PR #214 — 3 real bugs block the merge; 4 quarantined flaky failures ignored by design…",
    stats: [
      { label: "PRs Gated", value: 1, suffix: "" },
      { label: "Flaky Ignored", value: 4, suffix: "" },
    ],
  ...
  },
  {
    ...
    subtitle: "Full chain: execute → heal → report → visual → notify",
    stage: "pipeline",
    activity: "Orchestrating complete pipeline: 14 stages chained — 11 complete, 3 in-flight, ETA 42 seconds…",
    stats: [
      { label: "Stages Complete", value: 11, suffix: "/14" },
